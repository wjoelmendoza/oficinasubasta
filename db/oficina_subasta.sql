...
INSERT INTO USUARIO(nombres, clave, id_rol) VALUES("administrador", "123456", 2);
...
DELIMITER //
CREATE OR REPLACE TRIGGER v_membresia_insert AFTER INSERT ON MEMBRESIA FOR EACH ROW BEGIN
